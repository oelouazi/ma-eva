...
<!-- Container cliquable pour ajouter les cœurs -->
<div
  role="button"
  tabindex="0"
...
>
  ...
  <h1 class="text-2xl sm:text-3xl text-pink-600 font-bold mb-4 sm:mb-6 text-center">
    Poésies ✨
  </h1>
  ...
  {#if tab === 'fr'}
    <div
      id="poem-fr"
      class="w-full max-w-xl bg-white p-5 sm:p-6 rounded-2xl shadow-lg text-pink-700 leading-relaxed text-base sm:text-lg space-y-4 animate-[fadeIn_200ms_ease]"
    >
      <p>
  ...
  <!-- Bouton fixe retour à l'accueil -->
  <a
    href="{base}/"
